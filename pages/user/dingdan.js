...
Page({  
  ...
  onLoad: function(options) {  
    ...
    if (op == null || op == '') {
      ...
      wx.showModal({
        title: '温馨提示',
        content: '必须先进入‘我的’页面进行登录才能显示你的订单哦！',
    ...
    wx.request({
      url: 'https://api.ceiling.wanwukj.cn/Decoration/order/get_order.do',
      data: {
      ...
      success: function (res) {
        ...
        // console.log(result[0].orderName)
        that.setData({
          orderList0: result
        })
      }
...
//   var that = this
//   console.log("ssssssssssss======" + wx.getStorageSync("open_id"))
//   if (wx.getStorageSync("open_id") == null) {
//     wx.showToast({
//       title: '数据显示失败，请重新登录',
//       duration: 2000
//     })
...
//       data: {
//         //   wx.getStorageSync("open_id")
//         openId: 'oXPIP5SQ5WxU3y57g4RIuljWw-m8',
//       },
//       success: function (res) {
//         var result = res.data.data
//         console.log("sss=========++++==" + result)
